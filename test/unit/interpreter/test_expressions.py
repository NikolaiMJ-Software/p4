...
def test_or_true():
    ...
    assert checker.visit(node) is True
...
def test_or_false():
    ...
    assert checker.visit(node) is False
...
def test_indexaccess_struct():
    ...
    checker.v_tables = [{"X":{"Z":[[1,2,3],4,5]}}]
