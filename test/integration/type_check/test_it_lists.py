...
def test_it_pass_create_empty_list():
    ...
    assert ["list"] == result
create_empty_list_code = """create X listing:
"""
...
create_typed_int_list_code = """create X listing: 1, 2, 3
"""
...
create_typed_string_list_code = '''create X listing: "A", "B"
'''
...
index_access_typed_list_code = """create X listing: 1, 2, 3
index 0 of X
"""
...
index_access_generic_list_code = """create X listing:
index 0 of X
"""
...
def test_it_pass_assign_to_list_index_valid():
    ...
    assert ["list[int]", "int"] == result
assign_to_list_index_valid_code = """create X listing: 1, 2, 3
index 0 of X is 99
"""
...
def test_it_pass_list_index_used_in_variable_creation():
    ...
    assert ["list[int]", "int"] == result
list_index_used_in_variable_creation_code = """create X listing: 1, 2, 3
...
def test_it_pass_index_access_in_expression():
    ...
    assert ["list[int]", "int"] == result
index_access_in_expression_code = """create X listing: 1, 2, 3
...
def test_it_fail_create_list_mixed_types():
    with pytest.raises(TypeError) as exc_info:
        type_check_test(create_list_mixed_types_code)
    assert "mixed types" in str(exc_info.value)
create_list_mixed_types_code = '''create X listing: 1, "A"
'''
...
index_access_non_int_index_code = '''create X listing: 1, 2, 3
index "0" of X
'''
...
assign_to_list_index_wrong_value_type_code = '''create X listing: 1, 2, 3
